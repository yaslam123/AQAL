            ...
            <div className="col-lg-8">
              <div className="mil-center mil-mb-120">
                ...
                <p className="mil-text-lg mil-up">
                  Aqal Engineering Solutions is a leader in resilient
                  construction and sustainable engineering, blending Somali
                  architectural heritage with cutting-edge modern designs. We
                  are dedicated to delivering culturally enriched infrastructure
                  that stands the test of time while meeting the environmental
                  and community needs unique to Somalia.
                </p>
              </div>
            </div>
          </div>
